...
<table border="1">
    ...
    $tampil = tampil($tabel, "where id_karyawan = '$id_karyawan' and tanggal BETWEEN '$tanggal1' and '$tanggal2' order by tanggal asc");
    ...
    <tbody>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?= $data['output'] ?></td>
                <td><?= $data['satuan'] ?></td>
                <td><?= ($data['file_pekerjaan'] == '-' || $data['file_pekerjaan'] == '') ? '' : '<a href="' . $base_url . '/file/file_pekerjaan/' . $data['file_pekerjaan'] . '">Lihat file</a>'; ?></td>
                <td><?= $status ?></td>
                <td><?= $data['nilai'] ?></td>
